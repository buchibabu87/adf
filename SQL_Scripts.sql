...
insert into [dbo].[JOB_LIST_DYNAMIC] values(1,'countries','localhost','sales_read','sales_read','sh','sh','countries','E:/files/SH/','raveendra','password','countries','countries','csv','/mnt/landing/sales/','countries','countries','csv','stg_sales','sales','stg_countries','COUNTRY_ID','curation_sales','sales','curation_countries','COUNTRY_ID','dw_sales','sales','dim_countries','COUNTRY_KEY','/mnt/raw/sales/','countries','countries','csv','countries_schema',1,GETDATE(),'ETLJOB',GETDATE(),'ETLJOB');
insert into [dbo].[JOB_LIST_DYNAMIC] values(2,'channels','localhost','sales_read','sales_read','sh','sh','channels','E:/files/SH/','raveendra','password','channels','channels','csv','/mnt/landing/sales/','channels','channels','csv','stg_sales','sales','stg_channels','CHANNEL_ID','curation_sales','sales','curation_channels','CHANNEL_ID','dw_sales','sales','dim_channels','CHANNEL_KEY','/mnt/raw/sales/','channels','channels','csv','channels_schema',1,GETDATE(),'ETLJOB',GETDATE(),'ETLJOB');
insert into [dbo].[JOB_LIST_DYNAMIC] values(3,'customers','localhost','sales_read','sales_read','sh','sh','customers','E:/files/SH/','raveendra','password','customers','customers','csv','/mnt/landing/sales/','customers','customers','csv','stg_sales','sales','stg_customers','CUST_ID','curation_sales','sales','curation_customers','CUST_ID','dw_sales','sales','dim_customers','CUST_KEY','/mnt/raw/sales/','customers','customers','csv','customers_schema',1,GETDATE(),'ETLJOB',GETDATE(),'ETLJOB');
insert into [dbo].[JOB_LIST_DYNAMIC] values(4,'product','localhost','sales_read','sales_read','sh','sh','product','E:/files/SH/','raveendra','password','product','product','csv','/mnt/landing/sales/','product','product','csv','stg_sales','sales','stg_product','PROD_ID','curation_sales','sales','curation_product','PROD_ID','dw_sales','sales','dim_product','PROD_KEY','/mnt/raw/sales/','product','product','csv','product_schema',1,GETDATE(),'ETLJOB',GETDATE(),'ETLJOB');
...
insert into [dbo].[JOB_LIST_DYNAMIC] values(6,'times','localhost','sales_read','sales_read','sh','sh','times','E:/files/SH/','raveendra','password','times','times','csv','/mnt/landing/sales/','times','times','csv','stg_sales','sales','stg_times','TIME_ID','curation_sales','sales','curation_times','TIME_ID','dw_sales','sales','dim_times','TIME_KEY','/mnt/raw/sales/','times','times','csv','times_schema',1,GETDATE(),'ETLJOB',GETDATE(),'ETLJOB');
insert into [dbo].[JOB_LIST_DYNAMIC] values(7,'sales_transaction','localhost','sales_read','sales_read','sh','sh','sales_transaction','E:/files/SH/','raveendra','password','sales_transaction','sales_transaction','csv','/mnt/landing/sales/','sales_transaction','sales_transaction','csv','stg_sales','sales','stg_sales_transaction','','curation_sales','sales','curation_sales_transaction','','dw_sales','sales','fact_sales_transaction','','/mnt/raw/sales/','sales_transaction','sales_transaction','csv','sales_schema',1,GETDATE(),'ETLJOB',GETDATE(),'ETLJOB');
insert into [dbo].[JOB_LIST_DYNAMIC] values(8,'costs_transaction','localhost','sales_read','sales_read','sh','sh','costs_transaction','E:/files/SH/','raveendra','password','costs_transaction','costs_transaction','csv','/mnt/landing/sales/','costs_transaction','costs_transaction','csv','stg_sales','sales','stg_costs_transaction','','curation_sales','sales','curation_costs_transaction','','dw_sales','sales','fact_costs_transaction','','/mnt/raw/sales/','costs_transaction','costs_transaction','csv','costs_schema',1,GETDATE(),'ETLJOB',GETDATE(),'ETLJOB');
